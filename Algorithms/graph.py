...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        return map(lambda x:x.to_tuple(), self.edges)
    ...
    def get_adjacency_list(self):
        ...
        (To Node, Edge Value)"""
        # pre create list
        adjacency_list = [None for node in self.nodes]
        for edge in self.edges:
            # create edge list if non existing
    ...
    def get_adjacency_matrix(self):
        ...
        for edge in self.edges:
            matrix[edge.node_from.value-1][edge.node_to.value-1] = edge.value
